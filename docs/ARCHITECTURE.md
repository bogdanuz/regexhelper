...
| **Ручной редактор** | [docs/EDITOR_PANEL_SPEC.md](EDITOR_PANEL_SPEC.md) | Ручной ввод/правка regex: вставка параметров в курсор, Проверить, Сохранить в историю, В визуализатор/тестер; приём из панели результата и из карточек истории («В редактор» — полная замена). |
