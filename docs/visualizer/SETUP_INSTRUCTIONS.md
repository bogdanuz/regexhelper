...
7. Проверьте зум (кнопки − и + — зум к центру; Ctrl+колёсико мыши в области диаграммы — зум к курсору, как в Miro/Figma) и пан (ЛКМ + перетаскивание; скроллбара в области диаграммы нет). После «Визуализировать» диаграмма сразу вписывается в поле и центрируется (fit to view).
