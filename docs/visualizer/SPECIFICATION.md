...
- У визуализатора есть строка вкладок; каждая вкладка соответствует одной построенной диаграмме.
- При каждом запуске «Визуализировать» или вызове из других инструментов (кнопка «В визуализатор») создаётся **новая вкладка**, предыдущие диаграммы остаются доступными.
